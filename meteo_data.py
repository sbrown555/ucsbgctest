...
filter_options = ['none'] + indicator_columns
filter_variables = st.multiselect(label = "Choose variables to filter by:", options = filter_options, default = 'none', key = 'filter_variables')
